...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context)
    {
        ...
        context.Activities.AddRange(activities); //EF tracking that something has changed in memory DB not updated yet
        await context.SaveChangesAsync();  //DB is now updated
    }
}
